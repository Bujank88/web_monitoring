@extends('master')
@section('title') Upload Report Maxim @endsection
        ...
        <div class="card upload-card h-100">
            <div class="card-header">
                <h3 class="card-title mb-0" style="font-weight: 700;">
                    <i class="fas fa-file-arrow-up mr-2"></i>Upload Excel Report Maxim
                </h3>
            </div>
            <div class="card-body">
                <p class="text-muted mb-4">Upload file report Maxim khusus admin. Format file mengikuti template yang sudah disediakan.</p>

                <form action="{{ route('admin.upload.maxim-report.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="helper-box mb-4">
                        ...
                        <p class="mb-3">Gunakan template dummy berikut sebagai acuan sebelum upload.</p>
                        <a href="{{ $templateFile }}" class="btn btn-outline-primary" target="_blank">
                            <i class="fas fa-file-excel mr-1"></i>Download Template Laporan Maxim
                        </a>
                    </div>
    ...
    <div class="col-lg-5 mb-4">
        <div class="card upload-card h-100">
            ...
            <div class="card-body">
                ...
                <div class="text-muted">Belum ada file report Maxim yang diupload.</div>
                @else
