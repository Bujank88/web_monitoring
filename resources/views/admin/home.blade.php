        ...
        <div class="card-body filter-section mb-0" id="lokasiKerjaFilterContainer">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12">
                    ...
                    <select id="filterLokasiKerja"

                            name="lokasi_kerja[]"

                            class="form-control select2-custom"

                            data-placeholder="Semua lokasi kerja"
    ...
    <div class="card" id="canvaserTableCard">
       ...
       <div class="card-header bg-gradient-success text-white">
        ...
        <div class="card-body">
            ...
            @php
                $date = request('month') ? \Carbon\Carbon::createFromFormat('Y-m', request('month')) : now();
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#filterLokasiKerja').select2({

            theme: 'bootstrap-5',

            width: '100%',

            dropdownParent: $('#lokasiKerjaFilterContainer'),
        ...
        function syncLokasiKerjaOptions(rows) {
            ...
            const locations = [...new Set(
                ...
                rows
                    ...
                    .map(row => String(row.lokasi_kerja || '').trim())
            ...
            locations.forEach(location => {
                ...
                $filter.append(new Option(location, location, false, selectedLocations.includes(location)));

            });

            $filter.val(selectedLocations.filter(location => locations.includes(location)));
