@extends('master')
@section('title') Report AM Level UP @endsection
    ...
    <div class="filter-row">
        ...
        <div class="filter-group">
            ...
            <select id="source" name="source" class="form-control">
                ...
                <option value="user_panen_poin">User AM Level UP</option>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#reportTable').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('amlevelup.report-data') }}",
                data: function(d) {
                ...
                },
                {
                    ...
                    render: function(data) {
                        if (data === 'user_panen_poin') {
                            return '<span class="badge badge-primary"><i class="fas fa-user-edit"></i> AM Level UP</span>';
                        } else {
        ...
        $('#btn-export').click(function() {
            ...
            var exportUrl = "{{ route('amlevelup.export') }}" + "?tanggal=" + tanggal + "&source=" + source + "&remark=" + remark;
