@extends('master')
@section('title') AM Level UP Report Powerhouse @endsection
@section('css')
<!-- Select2 CSS -->
...
<!-- Report amlevelup Powerhouse -->
<div class="row mb-4">
    <div class="col-12">
        <div class="card" id="amlevelupTableCard">
            <div class="card-header bg-gradient-danger text-white">
                <h4 class="mb-0"><i class="fas fa-table"></i> Report amlevelup Powerhouse</h4>
            </div>
            <div class="card-body">
                <div id="captureamlevelupTable" class="table-responsive">
            <table class="table table-sm w-100 table-bordered table-hover" id="amlevelupPHTable" style="font-size: 13px;">
                        <thead class="table-light">
                            <tr style="background-color: #e8eaf6; font-weight: bold;">
                                <th colspan="5" style="text-align: center; padding: 10px; border-bottom: 2px solid #667eea;">Report amlevelup Powerhouse | Bulan: <span id="displayedMonthPH">{{ $months[array_search(true, array_column($months, 'selected'))]['label'] ?? now()->format('F Y') }}</span></th>
                            </tr>
                            <tr>
                                <th style="text-align: center; width: 5%;">No</th>
                                <th style="text-align: center;">Powerhouse Name</th>
                        ...
                        <tfoot>
                            <tr style="background: linear-gradient(135deg, #fffb00 0%, #ffee00 100%); color: white; font-weight: 600;">
                                ...
                                <td id="totalJumlahTerdaftarPH" style="text-align: center; padding: 12px;">0</td>
                                <td id="totalJumlahAkunPunyaPoinPH" style="text-align: center; padding: 12px;">0</td>
                                <td id="totalJumlahPoinPH" style="text-align: center; padding: 12px;">0</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#amlevelupPHTable').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            paging: false,
            ...
            info: false,
            ajax: {
                url: "{{ route('amlevelup.report-ph-data') }}",
                type: 'GET',
                data: function(d) {
        ...
        function calculateTotals() {
            ...
            $('#amlevelupPHTable tbody tr').each(function() {
            ...
            // Update total row
            $('#totalJumlahTerdaftarPH').text(totalTerdaftar);
            $('#totalJumlahAkunPunyaPoinPH').text(totalAkunPunyaPoin);
            $('#totalJumlahPoinPH').text(totalPoin);
        }
    });
</script>
@endsection
