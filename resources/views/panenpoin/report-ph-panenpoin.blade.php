@extends('master')
@section('title') Panen Poin Report Powerhouse @endsection
@section('css')
<!-- Select2 CSS -->
...
<!-- Report PanenPoin Powerhouse -->
<div class="row mb-4">
    <div class="col-12">
        <div class="card" id="panenPoinTableCard">
            <div class="card-header bg-gradient-danger text-white">
                <h4 class="mb-0"><i class="fas fa-table"></i> Report PanenPoin Powerhouse</h4>
            </div>
            <div class="card-body">
            ...
            <table class="table table-sm w-100 table-bordered table-hover" id="panenPoinPHTable" style="font-size: 13px;">
                        <thead class="table-light">
                            <tr style="background-color: #e8eaf6; font-weight: bold;">
                                <th colspan="5" style="text-align: center; padding: 10px; border-bottom: 2px solid #667eea;">Report PanenPoin Powerhouse | Bulan: <span id="displayedMonthPH">{{ $months[array_search(true, array_column($months, 'selected'))]['label'] ?? now()->format('F Y') }}</span></th>
                            </tr>
                            <tr>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#panenPoinPHTable').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            paging: false,
            ...
            info: false,
            ajax: {
                url: "{{ route('panenpoin.report-ph-data') }}",
                type: 'GET',
                data: function(d) {
        ...
        function calculateTotals() {
            ...
            $('#panenPoinPHTable tbody tr').each(function() {
