...
<body>
    <div class="container">
        <div class="header">
            <h1><span class="emoji">🎉</span> Akun AM Level UP Anda Telah Dibuat!</h1>
        </div>
        
        <div class="content">
            <p>Halo <strong>{{ $nama_akun }}</strong>,</p>
            
            <p>Selamat! Akun AM Level UP Anda telah berhasil dibuat. Berikut adalah kredensial login Anda:</p>
            ...
            <p>Silakan login menggunakan kredensial di atas untuk mengakses sistem AM Level UP.</p>
            
            <div style="background: #e8f5e9; border-left: 4px solid #4caf50; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p><strong>🚀 Langkah Selanjutnya:</strong></p>
                <ol>
                    <li>Kunjungi website AM Level UP: <strong><a href="https://iam.tracer.myads-tracers.com/" style="color: #2196F3; text-decoration: none;">https://amlevelup-myads.com/</a></strong></li>
            ...
            <p>Terima kasih telah menggunakan layanan AM Level UP!</p>
        </div>
        
        <div class="footer">
            <p>&copy; {{ date('Y') }} MyAds-Telkomsel-Program AM Level UP. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
