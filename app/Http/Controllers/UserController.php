...
class UserController extends Controller
{
    ...
    public function storeUser(Request $request)
    {
        $request->validate([
            ...
            'role'  => 'required|in:Admin,Tsel,Treg,cvsr,PH,AM,AM Leader,TCD,Internal,b2b,Maxim,Automatech,GOTO,CDSI,KSS,Regional,Area 2,MPCC,SBP,Canvasser SBP,Dormant,1Synergy',
            ...
            'referral_code' => [
                ...
                function ($attribute, $value, $fail) use ($request) {
                    if ($request->role === 'AM' && !preg_match('/^AM(?:[1-9]|1[0-5])$/i', trim((string) $value))) {
                        $fail('Referral Code untuk role AM harus AM1 sampai AM15.');
                    }
